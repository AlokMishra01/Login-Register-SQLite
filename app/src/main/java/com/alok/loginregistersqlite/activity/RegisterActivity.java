package com.alok.loginregistersqlite.activity;
...
import com.alok.loginregistersqlite.R;
import com.alok.loginregistersqlite.helpers.InputValidation;
import com.alok.loginregistersqlite.model.User;
import com.alok.loginregistersqlite.sql.DatabaseHelper;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void postDataToSQLite() {
        ...
        if (!inputValidation.isInputEditTextMatches(textInputEditTextPassword, textInputEditTextConformPassword,
                textInputLayoutConformPassword, getString(R.string.error_password_match))) {
            return;
        }
